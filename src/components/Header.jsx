...
const Header = () => {
  ...
  return (
    <header className='flex justify-between items-center py-4 px-4 lg:px-20'>
      ...
      <button className='md:hidden text-3xl p-2 z-50'> <i class='bx  bx-menu-filter'></i> </button>
    <div id="" className=' hidden fixed top-16 bottom-0 right-0 left-0 p-5 md:hidden z-40 bg-black bg-opacity-70 backdrop-blur-md '>
